...
export default function PlatformShowcase() {
  return (
    <section className="relative py-24 lg:py-32 px-6 overflow-hidden">
      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1100px] h-[520px] pointer-events-none"
        style={{
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[0.95fr_1.45fr] gap-10 items-center">
        <div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.title} className="glass-card p-5 rounded-[24px]">
        ...
        <div className="relative">
          <div className="glass-card rounded-[32px] overflow-hidden border-[rgba(148,163,184,0.22)] shadow-[0_30px_120px_rgba(2,6,23,0.55)]">
                  ...
                  <div className="rounded-[24px] border border-white/8 bg-white/[0.03] p-5">
                    ...
                    <div className="space-y-4">
                      {activityFeed.map((item) => (
                        <div key={item.title} className="rounded-xl border border-white/8 bg-slate-950/40 p-3.5">
          ...
          <div className="hidden sm:block absolute -right-6 top-10 w-52 rounded-[24px] border border-[rgba(245,158,11,0.2)] bg-[rgba(10,12,18,0.92)] p-4 shadow-[0_16px_40px_rgba(2,6,23,0.45)]">
