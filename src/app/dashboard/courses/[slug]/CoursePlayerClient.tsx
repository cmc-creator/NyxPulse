          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-slate-300 space-y-2">
              <p className="text-white font-semibold">
                American Red Cross instructor-led program
              </p>
              <p>
                Taught by {course.instructor?.name ?? "a Red Cross certified instructor"}.
                These modules prepare you for your skills session. Your official Red Cross
                digital certificate is issued through the Red Cross Learning Center after
                skills verification — not generated by NyxPulse.
              </p>
              <Link
              ...
              >
                How Red Cross certification works <ExternalLink className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-2 text-xs text-slate-500">
          ...
          {progress === 100 && (
            <span className="text-green-400 font-semibold flex items-center gap-1">
              ...
              {isArc ? "Prep complete" : "Ready to claim"}
            </span>
          )}
        </div>
          ...
          <div className="mt-4 pt-4 border-t border-[rgba(255,255,255,0.06)] flex flex-col sm:flex-row items-center gap-3">
            {isCompleted ? (
              ...
              >
                ...
                {isArc ? "View Prep Completion Record" : "View Your Certificate"}
              </Link>
            ) : (
              <>
                <button
                ...
                >
                  {claiming ? (
                    ...
                    <>
                      <Award className="w-4 h-4" />
                      {isArc ? "Mark Prep Complete" : "Claim Certificate"}
                    </>
                  )}
                </button>
                <span className="text-xs text-slate-500">
                  {isArc
                    ? "Next: attend your instructor skills session for the official Red Cross certificate."
